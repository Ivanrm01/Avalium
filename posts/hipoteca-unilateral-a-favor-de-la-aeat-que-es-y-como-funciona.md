---
title: "Hipoteca unilateral a favor de la AEAT: qué es y cómo funciona"
tag: Hipoteca unilateral
date: 2026-09-06
author: Equipo Avalium
reading_time: 10 min
summary: Qué es la hipoteca unilateral a favor de la AEAT, para qué sirve, cómo
  se constituye paso a paso, qué cuesta y cuándo es la alternativa al aval
  bancario para aplazar, fraccionar o suspender una deuda.
lede: La hipoteca unilateral a favor de la AEAT es una garantía que constituyes
  sobre un inmueble propio para aplazar, fraccionar o suspender una deuda
  tributaria sin aval bancario. Te explicamos qué es, cómo funciona y cuándo
  conviene usarla.
seo_title: "Hipoteca unilateral a favor de la AEAT: qué es"
meta_description: "Qué es la hipoteca unilateral a favor de la AEAT y cómo
  funciona: para qué sirve, cómo se constituye y por qué es la alternativa al
  aval bancario."
focus_keyword: hipoteca unilateral a favor de la aeat
faq:
  - pregunta: ¿Qué es una hipoteca unilateral a favor de la AEAT?
    respuesta: "Es una garantía que constituye el propietario de un inmueble, él
      solo, a favor de Hacienda, para respaldar el aplazamiento, el
      fraccionamiento o la suspensión de una deuda tributaria. No es un préstamo
      ni genera nueva deuda: solo pone el inmueble como respaldo. La
      Administración la acepta después, dejando constancia en el Registro de la
      Propiedad."
  - pregunta: ¿Cuánto tiene que valer el inmueble para servir de garantía?
    respuesta: Debe cubrir el principal de la deuda más los intereses, los recargos
      y un margen adicional. Como referencia, la AEAT pide que un inmueble
      urbano, tras descontar cargas previas, supere el 115 % de la deuda, y un
      inmueble rústico, al menos el 200 %. Si no alcanza esa cobertura, la
      garantía no será aceptada.
  - pregunta: ¿Hay que pagar AJD por una hipoteca unilateral a favor de Hacienda?
    respuesta: En principio no. El Tribunal Supremo y el TEAC consideran que el
      sujeto pasivo del Impuesto de Actos Jurídicos Documentados es la propia
      Administración beneficiaria, que está exenta (art. 45.I.A del texto
      refundido del ITP y AJD). En la práctica, algunas comunidades autónomas
      todavía lo liquidan y puede ser necesario reclamar la exención.
toc: true
noindex: false
featured: false
featured_quote: No es un préstamo ni te da liquidez. Es tu patrimonio convertido
  en capacidad de negociación frente a la AEAT.
related:
  - mins: 8 min
    slug: la-aeat-flexibiliza-la-tasacion-de-inmuebles-aportados-como-garantia-en-aplazamientos-y-fraccionamientos
...
- **No es un préstamo.** No recibes dinero ni asumes una nueva deuda. Solo ofreces un inmueble como respaldo de una deuda que ya existe.
- **No genera intereses ni comisiones propias.** A diferencia de un aval bancario, no hay comisiones recurrentes de mantenimiento.
- **La constituyes tú solo.** No necesitas que Hacienda firme contigo; la aceptación llega después, dentro del propio procedimiento.
...
- **Inmuebles urbanos**, incluso con cargas previas, siempre que, tras descontar esas cargas, el valor supere el **115 %** de la deuda.
- **Inmuebles rústicos**, con un valor que asegure al menos el **200 %** de la deuda.
...
- Funciona cuando el banco no avala o el aval es demasiado caro.
- Usa un inmueble que ya tienes, sin venderlo.
- Costes de una sola vez y sin comisiones recurrentes.
- En principio, exenta de AJD.
- Sirve tanto para aplazar o fraccionar como para suspender.

**A tener en cuenta:**

- **No te da liquidez.** No es dinero; es respaldo. Si lo que necesitas es caja, esta no es la herramienta.
- **El inmueble queda gravado.** Si incumples la deuda garantizada, puede ejecutarse.
- **Plazos estrictos** para constituir e inscribir, y una tasación que debe estar vigente.
- **La AEAT no acepta cualquier cosa:** la garantía debe ser suficiente y estar bien documentada.
...
- La deuda es de las que la ley declara inaplazables (retenciones, pagos fraccionados del Impuesto sobre Sociedades, IVA repercutido y cobrado).
- El inmueble, descontadas sus cargas, no alcanza la cobertura mínima que exige la AEAT.
- Lo que necesitas en realidad es liquidez inmediata, no una garantía.
- El coste y los plazos del proceso no compensan frente al importe de la deuda.
