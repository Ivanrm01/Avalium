---
title: "Cómo aplazar una deuda con Hacienda en 2026: requisitos, plazos,
...
1. Accede a **Recaudación → Aplazamiento y fraccionamiento de deudas**.
2. Identifica la deuda con su **clave de liquidación**.
3. Indica el **número de plazos**, la periodicidad y la fecha del primer pago (día 5 o 20 del mes).
4. Señala la **cuenta bancaria** para domiciliar los pagos (salvo NIF que empiecen por E, H o U).
5. Indica el motivo y, si la deuda supera los 50.000 €, aporta la **garantía**.
...
La buena noticia es que el aval bancario no es la única garantía admitida. También lo son el seguro de caución, la prenda y, sobre todo, la **hipoteca sobre un inmueble**. Si tienes un inmueble con valor suficiente, puedes ofrecerlo como garantía mediante una [hipoteca unilateral a favor de la AEAT](/hipoteca-unilateral-a-favor-de-la-aeat) y aplazar la deuda sin depender del banco. Es la vía que trabajamos en Avalium para [aplazar o fraccionar sin aval bancario](/servicios/aplazar-fraccionar-deuda-aeat-sin-aval).

Además, desde abril de 2026 [una sentencia obligó a la AEAT a flexibilizar la tasación de esos inmuebles](/blog/tasacion-inmueble-garantia-aplazamiento-fraccionamiento-aeat): ya no hace falta un tasador inscrito en un registro oficial para aplazamientos y fraccionamientos, lo que amplía las formas de acreditar el valor del bien.
